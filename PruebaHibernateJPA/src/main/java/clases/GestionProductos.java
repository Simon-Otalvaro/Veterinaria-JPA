...
public class GestionProductos {
    ...
    public GestionProductos() {
        ...
        while(opc!=8) {
            ...
            switch (opc) {
                ...
                case 5: comprarProductos(); break;
                case 6: actualizar(); break;
                case 7: eliminar(); break;
                case 8: miProductoDao.close(); break;
            }
        }
    }
    ...
    private void comprarProductos() {
        ...
        Long productoId;
        Long cantidad;
        LocalDate fechaCompra = LocalDate.now(); // Obtener la fecha actual
        int opc = 0;
        do {
            try {
                ...
                cantidad = Long.parseLong(JOptionPane.showInputDialog("Ingrese la cantidad del producto"));
// Registrar la compra en el DAO
                String resultado = miProductoDao.registrarCompra(personaId, productoId, Math.toIntExact(cantidad), fechaCompra);
